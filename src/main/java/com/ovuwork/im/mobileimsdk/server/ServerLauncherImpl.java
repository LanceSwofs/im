...
{
	@Autowired
	private ServerEventListenerImpl serverEventListenerImpl;
	@Autowired
	private MessageQoSEventS2CListenerImpl messageQoSEventS2CListenerImpl;
...
//		BridgeProcessor.IMMQ_URI = "amqp://js:19844713@192.168.31.190";
    ...
    protected void initListeners()
    {
		...
		this.setServerMessageQoSEventListener(messageQoSEventS2CListenerImpl);
    }
}
